/**
 * EditorManager - Gerencia todas as opera+º+Áes do editor
 */
class EditorManager {
    ...
    renderNpcsList() {
        ...
        for (const npc of sprites) {
            ...
            dialog.textContent = npc.text || 'Sem di+ílogo';
    ...
    startPlacingNpc() {
        ...
        this.btnPlaceNpc.textContent = 'Cancelar coloca+º+úo';
...
<body>
    <div class="game-container">
        ...
        <div class="game-controls">
            ...
            <span>Setas para mover ÔÇó Z para interagir</span>
        </div>
    </div>
