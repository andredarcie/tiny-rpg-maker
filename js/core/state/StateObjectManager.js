class StateObjectManager {
    ...
    normalizeObjects(objects) {
        ...
        const allowedTypes = new Set(['door', 'door-variable', 'key', 'life-potion', 'xp-scroll']);
        return objects
            .map((object) => {
                ...
                return {
                    ...
                    x,
                    y,
                    collected: (type === 'key' || type === 'life-potion' || type === 'xp-scroll') ? Boolean(object?.collected) : false,
    ...
    resetRuntime() {
        ...
        this.game.objects.forEach((object) => {
            if (object.type === 'key' || object.type === 'life-potion' || object.type === 'xp-scroll') {
    ...
    setObjectPosition(type, roomIndex, x, y) {
        const normalizedType = ['door', 'door-variable', 'key', 'life-potion', 'xp-scroll'].includes(type) ? type : null;
        ...
        if (normalizedType === 'key' || normalizedType === 'life-potion' || normalizedType === 'xp-scroll') {
